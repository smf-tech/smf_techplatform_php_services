...
var jic = {
        ...
        compress: function(source_img_obj, quality, output_format,width,height){
			 ...
			 *///alert(cvs.width);alert(cvs.height);
			console.log(cvs.width+'---height'+cvs.height+'---JIS - width');
