        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <h3>Insert City</h3>
                    <form action="http://13.235.105.204/api/insertCity" method="post">
                        ...
                        <legend></legend>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="city_name" name="city_name" placeholder="City Name" class="form-control" required = "required" pattern="[a-zA-Z][a-zA-Z0-9\s]*" oninvalid="this.setCustomValidity('Please Enter Valid City Name')" oninput="setCustomValidity('')"/>
                             </div>
