...
class StructureController extends Controller
{
	...
	* 
	*/
	public function getStructureAnalystV2(Request $request) {
		...
		
	{
		...
		if ($sCount > 0) {
			$sCountPer = ($sCount / $sCount) * 100;

			$resultData[0]['percentValue'] = $sCountPer;
			$resultData[0]['status'] = 'Total Structure ('.$sCount.')';
			$resultData[0]['statusCode'] = 0;
		}
		...
		if ($this->request->has('taluka_id') && $this->request->taluka_id != "" ) {
			...
			if ($approvedCnt > 0) {
				...
				$approvedCntPer = ($approvedCnt / $sCount) * 100;
